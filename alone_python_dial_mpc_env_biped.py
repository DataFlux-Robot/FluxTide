...
BIPED_ENV_REGISTRY: Dict[str, Tuple[str, str]] = {
    "unitree_h1_walk": (_THIS_MODULE, "UnitreeH1WalkEnvConfig"),
    "unitree_h1_push_crate": (_THIS_MODULE, "UnitreeH1PushCrateEnvConfig"),
    "unitree_h1_loco": (_THIS_MODULE, "UnitreeH1LocoEnvConfig"),
}

register_envs(BIPED_ENV_REGISTRY)


@dataclass
class BipedSimulatorConfig(SimulatorConfig):
