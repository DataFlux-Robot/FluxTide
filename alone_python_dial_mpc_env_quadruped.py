...
from alone_python_dial_mpc_env_base import BaseEnv, BaseEnvConfig, SimulatorConfig, register_envs
from alone_python_dial_mpc_utils import (
...
QUADRUPED_ENV_REGISTRY: Dict[str, Tuple[str, str]] = {
    "unitree_go2_walk": (_THIS_MODULE, "UnitreeGo2EnvConfig"),
    "unitree_go2_seq_jump": (_THIS_MODULE, "UnitreeGo2SeqJumpEnvConfig"),
    "unitree_go2_crate_climb": (_THIS_MODULE, "UnitreeGo2CrateEnvConfig"),
}

register_envs(QUADRUPED_ENV_REGISTRY)


@dataclass
class QuadrupedSimulatorConfig(SimulatorConfig):
    env_name: str = "unitree_go2_walk"
